...
grub_target_cc_version='gcc (GCC) 14.3.1 20250523 (Red Hat 14.3.1-1)'
...
grub_target_cppflags='-I/builddir/build/BUILD/grub2-2.12-build/grub-2.12/grub-i386-pc-2.12 -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-redhat-linux/14/include -I$(top_srcdir)/include -I$(top_builddir)/include'
